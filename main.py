...
#output:
# Power = True, Channel = 0, Volume = 0
# Power = True, Channel = 2, Volume = 1
# Power = True, Channel = 1, Volume = 0
# Power = False, Channel = 1, Volume = 0
# Power = True, Channel = 3, Volume = 2
# Power = True, Channel = 1, Volume = 1
# Power = True, Channel = 3, Volume = 0
# Power = True, Channel = 3, Volume = 1
# Power = True, Channel = 3, Volume = 0
# Power = True, Channel = 3, Volume = 2
# Power = False, Channel = 3, Volume = 2
